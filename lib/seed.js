...
export async function ensureSeeded(db) {
  ...
  // 0. Indexes — idempotent, safe to run every time
  await db
    .collection("blogs")
    ...
    await db.collection("settings").insertOne({
      ...
      seo: {
        ...
        aiCrawlers: [
          ...
          {
            id: "google-extended",
            name: "Google / Google-Extended (Gemini)",
          ...
          {
            id: "perplexity-user",
            name: "Perplexity / Perplexity-User",
      ...
      llm: {
        ...
        siteTitle: "Vinimay",
        summary:
          "Vinimay is a comprehensive, easy-to-use business accounting, GST billing, and inventory management software platform designed specifically for small businesses, retailers, freelancers, and growing enterprises in India. It helps businesses manage GST invoices, sales, purchases, customer ledgers, vendor accounts, inventory tracking, and critical financial reports in one unified system.",
      },
      publishing: {
